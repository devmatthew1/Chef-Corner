...
class Orders extends Admin_Controller 
{
	...
	*/
	...
	/*
	* This is used to Fetch the orders data from the orders table 
	...
	*/
	public function fetchOrdersData()
	{
		...
		foreach ($data as $key => $value) {
			...
			//$newdate = date('d-m-Y', $value['date_time']);
			//$last_reading_time = $value['date_time'];
	...
	*/
	public function printDiv($id)
	{
		...
		if($id) {
			...
			$store_data = $this->model_stores->getStoresData($order_data['id']);
