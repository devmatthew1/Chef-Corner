  ...
  <div class="content-wrapper">
    ...
    <section class="content-header" style="padding: 20px 15px 20px 15px;">
      <h1>
        Manage
        Tables
      </h1>
       <ol class="breadcrumb " style="display: block;">
        <li>
          ...
          <?php if(in_array('createTable', $user_permission)): ?>
            <button class="btn btn-primary" data-toggle="modal" data-target="#addModal" class="btn" style="color: #fff; background-color: #022b69; margin: 0px 1px;">Add Table</button>
            <br /> <br />
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box" style="padding: 30px; border-radius: 10px;box-shadow: none;border-top: none;">
